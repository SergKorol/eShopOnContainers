...
namespace Ordering.SignalrHub
{
    public class Startup
    {
        ...
        private void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<OrderStatusChangedToAwaitingDiscountBalanceValidationIntegrationEvent, OrderStatusChangedToAwaitingDiscountBalanceValidationIntegrationEventHandler>();
