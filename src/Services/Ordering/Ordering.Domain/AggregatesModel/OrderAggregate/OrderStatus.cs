namespace Microsoft.eShopOnContainers.Services.Ordering.Domain.AggregatesModel.OrderAggregate
{
        ...
        : Enumeration
    {
        ...
        public static readonly OrderStatus StockConfirmed = new OrderStatus(8, nameof(StockConfirmed));
        public static readonly OrderStatus AwaitingValidation = new OrderStatus(9, nameof(AwaitingValidation));
