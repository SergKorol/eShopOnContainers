...
# echo
# echo "Building image \"catalog.api\"..."
# couponCmd="${azCliCommand}az acr build --registry $ESHOP_ACRNAME --image $ESHOP_REGISTRY/catalog.api:linux-net6-initial --file ./src/Services/Catalog/Catalog.API/Dockerfile ."
# echo "${newline} > ${azCliCommandStyle}$couponCmd${defaultTextStyle}${newline}"
# eval $couponCmd

# if [ ! $? -eq 0 ]
# then
#     echo "Error building Catalog.API!"
#     exit 1
# fi
